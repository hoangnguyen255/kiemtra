 ...
 * @Configuration
 * 
 * @AllArgsConstructor public class SpringSecurityConfig {
 * 
 ...
 * .requestMatchers("/nhanviens").hasAnyAuthority("ROLE_ADMIN", "ROLE_USER")
 * .requestMatchers("/nhanviens/create").hasAuthority("ROLE_ADMIN")
 * .requestMatchers("/nhanviens/edit").hasAuthority("ROLE_ADMIN")
 * .anyRequest().authenticated() ).formLogin( form -> form .loginPage("/")
 * .loginProcessingUrl("/login") .defaultSuccessUrl("/welcome") .permitAll()
